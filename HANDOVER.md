...
| M4 cartridge compatibility | In progress | Payload-launch and cartridge-INIT register/work-area state gated (`test-openmsx-payload-state`, `test-openmsx-cartridge`); remaining: mapper arrangements, redistributable compatibility corpus |
