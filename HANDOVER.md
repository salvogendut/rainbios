...
| M4 cartridge compatibility | In progress | Payload-launch and cartridge-INIT register/work-area state gated; page-2 INIT (mapper-style) arrangement gated (`test-openmsx-cartridge`/`-expanded-cartridge`/`-page2-cartridge`); remaining: redistributable compatibility corpus |
