...
Current verification on `main`: 208 host tests pass; the openMSX
controller, keyboard, cursor, VRAM, screen-mode, sprite, services, and startup-audio probes pass; Sunrise Nextor
...
| M2 MSX1 display/console | In progress | Remaining VDP, color, control-character, charset, and boundary behavior |
