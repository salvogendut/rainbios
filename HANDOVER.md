...
Current verification on `main`: 226 host tests pass; the openMSX
controller, keyboard, cursor, VRAM, screen-mode, sprite, GRPPRT, text-control, font, services, and startup-audio probes pass; Sunrise Nextor
...
| M2 MSX1 display/console | In progress | Remaining VDP, color, control-character, and boundary behavior |
