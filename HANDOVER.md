...
| M4 cartridge compatibility | In progress | Payload-launch register/work-area state gated by `test-openmsx-payload-state`; remaining startup-state contracts (cartridge INIT), mapper arrangements, redistributable compatibility corpus |
