...
make test-openmsx-audio test-openmsx-slots test-openmsx-expanded-slots \
  ...
  test-openmsx-payload-state test-openmsx-printer \
  test-openmsx-msx2 \
...
| M3 keyboard/PSG/basic devices | In progress | Printer calls implemented (`test-openmsx-printer`); remaining: touch-panel/light-pen/trackball detection, selectable frequency/locale |
