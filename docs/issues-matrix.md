...
| M6 completeness/optional | ~68% | Hook-dispatching disk baseline + GTPDL clobber contract gated; remaining: ABI gaps + flag/clobber characterization, loader inputs HL/DE, GeoBench rendering gap, payload-workload promotion, real-hardware timing |
