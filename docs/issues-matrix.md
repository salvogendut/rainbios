...
| M6 completeness/optional | ~80% | Disk baseline, GTPDL, INIFNK, ISCNTC/CKCNTC, CHGMOD, KEYINT, internal-payload graphics + cassette workloads gated; remaining: ABI gaps (RESET), loader inputs HL/DE (needs a kernel), GeoBench rendering gap, scroll/edit workload promotion, real-hardware timing |
