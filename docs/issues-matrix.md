...
| M6 completeness/optional | ~84% | Disk baseline, GTPDL, INIFNK, ISCNTC/CKCNTC, CHGMOD, KEYINT, internal-payload graphics/cassette/scroll/edit workloads gated; remaining: ABI gaps (RESET), loader inputs HL/DE (needs a kernel), GeoBench rendering gap, real-hardware timing |
