...
| M7 disk/IDE boot | ~95% | Exact/bounded FAT12 LOAD, DIR, multi-cluster WRITE/replace, embedded BASIC restart persistence, DSKFMT/CHOICE, DSKIO writes, MSX2 Nextor storage boot, and Nextor/internal-floppy coexistence gated; remaining: drive B, other controllers, real-hardware timing, CALSLT double-call crash, openMSX WD2793 data-transfer misalignment |
