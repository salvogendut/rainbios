...
| M6 completeness/optional | ~72% | Disk baseline, GTPDL, INIFNK, ISCNTC/CKCNTC gated; remaining: ABI gaps + flag/clobber characterization, loader inputs HL/DE, GeoBench rendering gap, payload-workload promotion, real-hardware timing |
