...
| M6 completeness/optional | ~82% | Disk baseline, GTPDL, INIFNK, ISCNTC/CKCNTC, CHGMOD, KEYINT, internal-payload graphics/cassette/scroll workloads gated; remaining: ABI gaps (RESET), loader inputs HL/DE (needs a kernel), GeoBench rendering gap, editing workload, real-hardware timing |
