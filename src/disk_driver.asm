...
;
; Shared WD2793 disk implementation: PHYDIO read/write, DSKCHG, GETDPB,
; DSKFMT, CHOICE, and cold-boot bootstrap hook.
; The including ROM must place this code in page 1.
...
; The default controller window is fixed at #7ff8. A test shell may define
