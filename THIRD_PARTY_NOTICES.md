...
| `4000h-7FFFh`, imported interpreter modules | R. T. Russell Z80 interpreter core, altered/ported for MSX | David Given's [CP/Mish `third_party/bbcbasic` subtree](https://github.com/davidgiven/cpmish/tree/master/third_party/bbcbasic), preserved and ported in `bbcbasic-z80-msx` commit `ad34c1c9489e6f4cf925cf6ca8c4e88588a095f3` | [`LICENSES/BBCBASIC-Z80.txt`](LICENSES/BBCBASIC-Z80.txt) (Zlib-style notice) |
