...
"""Run BBC BASIC under RainBIOS in 1983 and validate its wait state."""
...
def main() -> int:
    ...
    try:
        ...
        print(f"error: invalid 1983 BBC BASIC state: {error}", file=sys.stderr)
        return 1
    print(
        "validated 1983 BBC BASIC wait state: "
