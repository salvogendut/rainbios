...
"""Run the BBC BASIC scrolling text workload under RainBIOS in 1983."""
...
def main() -> int:
    ...
    try:
        ...
        print(f"error: invalid 1983 scroll state: {error}", file=sys.stderr)
        return 1
    print(
        "validated BBC BASIC scrolling workload in 1983: "
