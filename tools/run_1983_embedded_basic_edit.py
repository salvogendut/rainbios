...
"""Run the BBC BASIC editing workload against the internal embedded payload
...
def validate_state(text: str) -> dict[str, str]:
    ...
    try:
        ...
        raise ValueError("1983 emitted an invalid embedded editing state") from error
...
def main() -> int:
    ...
    try:
        ...
        print(f"error: invalid 1983 embedded editing state: {error}", file=sys.stderr)
        return 1
    print(
        "validated embedded payload editing workload in 1983: "
