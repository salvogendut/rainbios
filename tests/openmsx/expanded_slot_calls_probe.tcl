...
proc enaslt3_done {} {
    ...
    foreach {offset value} {
        0x5000 0x3A  0x5001 0xC7  0x5002 0xFC
        0x5003 0x32  0x5004 0x00  0x5005 0xF3
        0x5006 0x3E  0x5007 0x5A
        0x5008 0x01  0x5009 0x34  0x500A 0x12
        0x500B 0x11  0x500C 0x78  0x500D 0x56
        0x500E 0x21  0x500F 0xBC  0x5010 0x9A
        0x5011 0x37  0x5012 0xC9
    } {
