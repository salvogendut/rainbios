...
test-1983-sd-boot: \
		$(MSX1_ROM) $(NMS8250_DISK_ROM) $(MENU_IDE3_INPUT_CART) \
	...
	$(PYTHON) tools/check_boot_screenshot.py \
		--size 640x480 --min-colors 2 $(EMULATOR_1983_SD_BOOT_SCREEN)
...
test-1983-sd-menu: \
	...
	$(PYTHON) tools/check_boot_screenshot.py \
		--size 640x480 --min-colors 2 $(EMULATOR_1983_SD_MENU_SCREEN)
